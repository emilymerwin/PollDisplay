...
function parseQuestions(xml){
    ...
    // labelArr = ["Total", "Democrat", "Republican", "Independent", "White", "Black", "North Ga.", "Atlanta Exurbs", "Atlanta Metro", "Southeast Ga.", "Southwest Ga."];
		labelArr = ["Total", "Male", "Female", "High School or less", "Some college", "Vocational/Tech. School", "College Graduate", "Graduate Study", "Under $25,000", "$25-49,999", "$50-74,999", "$75-99,999", "$100-149,999", "Over $150,000", "White", "Black", "Other (race)", "18 - 29", "30 - 44", "45 - 64", "65+"];
