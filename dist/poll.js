$(document).ready(function(){
	$.ajax({
		type: "GET",
		url: "oct2020-poll.xml", // TODO: Update with infile from settings
		dataType: "xml",
...
function parseQuestions(xml){
    ...
    // labelArr = ["Total", "Democrat", "Republican", "Independent", "White", "Black", "North Ga.", "Atlanta Exurbs", "Atlanta Metro", "Southeast Ga.", "Southwest Ga."];
		labelArr = ["Total", "Male", "Female", "High School or less", "Some college", "BA or higher", "Under $25k", "$25-49,999", "$50-74,999", "$75-99,999", "$100-149,999", "Over $150k", "White", "Black", "Other race", "18 - 29", "30 - 44", "45 - 64", "65+", "Republican", "Independent", "Democrat"];
